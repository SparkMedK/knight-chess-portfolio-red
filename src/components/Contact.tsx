        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-300 mb-8">
              Whether you're interested in private training, group sessions, or have questions about upcoming tournaments, 
              please don't hesitate to reach out. I'll get back to you as soon as possible.
            </p>
            
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="bg-chess-knight-red rounded-full p-3">
                  <Mail className="h-5 w-5 text-white" />
                </div>
                <div>
                  <p className="text-sm text-gray-400">Email</p>
                  <p className="text-lg">contact@samionmagnus.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg">+46 70 123 4567</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              <p className="text-xl font-medium mb-4">Follow Me</p>
